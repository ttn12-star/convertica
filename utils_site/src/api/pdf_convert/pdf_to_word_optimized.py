...
class OptimizedPDFToWordConverter:
    ...
    async def _convert_with_pdf2docx_async(
        ...
        try:
            ...
            # Colorspace first: FzErrorArgument ("pixmap must be grayscale
            # or rgb") also starts with "Fz", and letting the repair branch
            # below claim it buried this recoverable CMYK case under a
            # "PDF is corrupted" message the file did not deserve.
