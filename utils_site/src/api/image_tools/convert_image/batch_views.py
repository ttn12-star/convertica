"""
Batch image conversion API views.

Supports processing up to 10 images simultaneously for premium users.
Each image is converted to the requested format and all results are returned in a ZIP archive.
"""
...
class ConvertImageBatchAPIView(APIView):
    ...
    def post(self, request: HttpRequest):
        """Handle batch image conversion with ZIP output."""
        ...
        try:
            ...
            tmp_dir = tempfile.mkdtemp(prefix="convert_img_batch_")
            output_files = []
            ...
            for idx, image_file in enumerate(image_files):
                try:
                    ...
                    input_path, output_path = convert_image(
                        image_file,
            ...
            zip_path = os.path.join(tmp_dir, "convert_image_batch.zip")
            ...
            response = FileResponse(
                open(zip_path, "rb"),
                as_attachment=True,
                filename="convert_image_convertica.zip",
            )
