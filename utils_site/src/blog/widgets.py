...
class TranslationsWidget(forms.Textarea):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        for lang in self.languages:
            ...
            output.append(f'<div class="translation-panel" data-lang="{lang}" style="display: {display};">')
        ...
        hidden_value = json.dumps(translations, ensure_ascii=False) if translations else '{}'
...
class AIMetadataWidget(forms.Textarea):
  ...
  "related_terms": ["PDF converter", "document tools"]
        ...
        textarea_value = json.dumps(metadata, ensure_ascii=False, indent=2) if metadata else '{}'
        output.append(
