...
class ArticleCategory(models.Model):
    ...
    translations = models.JSONField(
        ...
        help_text=_("Translations for other languages. Format: {\"ru\": {\"name\": \"...\", \"description\": \"...\"}, ...}")
    )
...
class Article(models.Model):
    ...
    excerpt_en = models.TextField(max_length=500, blank=True, verbose_name=_("Excerpt (English)"))
    ...
    translations = models.JSONField(
        ...
        blank=True,
        verbose_name=_("Translations"),
        help_text=_("Translations for other languages. Format: {\"ru\": {\"title\": \"...\", \"content\": \"...\", ...}, ...}")
    )
    
    # SEO fields (base language)
    meta_title_en = models.CharField(max_length=200, blank=True, verbose_name=_("Meta Title (English)"))
    meta_description_en = models.TextField(max_length=500, blank=True, verbose_name=_("Meta Description (English)"))
    meta_keywords_en = models.CharField(max_length=500, blank=True, verbose_name=_("Meta Keywords (English)"))
    ...
    ai_metadata = models.JSONField(
        ...
        help_text=_("Additional metadata for AI agents: topics, entities, summary, related_terms, etc.")
    )
    ...
    def _get_translation(self, field_name, language_code=None, default_field=None):
        ...
        if language_code == 'en' or language_code not in [lang[0] for lang in settings.LANGUAGES]:
            if default_field:
    ...
    def get_meta_description(self, language_code=None):
        ...
        result = self._get_translation('meta_description', language_code, 'meta_description_en')
        if result:
            return result
        # Fallback to excerpt
    ...
    def get_meta_keywords(self, language_code=None):
        ...
        result = self._get_translation('meta_keywords', language_code, 'meta_keywords_en')
