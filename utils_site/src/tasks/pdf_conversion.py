...
@shared_task(bind=True, name='pdf_conversion.convert_pdf_to_word', queue='pdf_conversion')
def convert_pdf_to_word_task(
    ...
    **kwargs
    ...
    try:
        ...
        # Perform conversion
        pdf_path, docx_path = convert_pdf_to_word(
            uploaded_file,
            suffix="_convertica"
        )
...
@shared_task(bind=True, name='pdf_conversion.convert_word_to_pdf', queue='pdf_conversion')
