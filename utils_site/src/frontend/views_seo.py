...
# /scanned-pdf-to-word/ and /batch-converter/ are intentionally NOT blocked:
# both are commercial keywords with public crawlable landings; the actual
# operations remain premium-gated at the app layer.
Disallow: /premium/
Disallow: /*/premium/
