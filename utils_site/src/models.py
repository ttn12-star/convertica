...
class Tool(models.Model):
    ...
    category: models.CharField = models.CharField(max_length=20, choices=CATEGORY_CHOICES)
    language: models.CharField = models.CharField(max_length=2, choices=LANGUAGE_CHOICES, default='en')
