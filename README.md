...
Проект настроен для автоматического CI/CD через GitHub Actions:
- Автоматические тесты
- Линтинг и проверка безопасности
- Автоматическая сборка Docker образов
- Multi-platform builds (amd64, arm64)

Подробнее: [ci/README_CI.md](ci/README_CI.md)
...
**Convertica** - Ваш надежный помощник в работе с PDF! 🚀
